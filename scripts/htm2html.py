...
styles = {
    ...
    "8A-English Pale Ale-Standard/Ordinary Bitter": ("3F", "English ordinary bitter"),
    "8B-English Pale Ale-Special/Best/Premium Bitter": ("4A", "English best bitter"),
...
for fn in sys.argv[1:]:
    ...
    if len(steps) > 1:
        ...
        d["mash"] += templates.row3("Saccharification rest", "60 min", "66 °C")
    ...
    batch = batch.strip(":")
    brewdate = time.strftime("%Y-%m-%d", time.strptime(data["brewed"], "%d %b %Y"))
