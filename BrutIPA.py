...
from brew.fermentables import PaleAleMalt, FlakedMaize, Amylase
...
class Recipe(brew.Recipe):
    def __init__(self):
        ...
        self.fermentables = [PaleAleMalt(5), FlakedMaize(0.5), Amylase(0.01)]
        self.hops = [Perle(5, 15), Perle(75, 0)]
